...
export class LibraryMetadata extends Component {
    ...
    metadataTabContent: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.metadataTabContent)
    );
    metadataTabAction: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.metadataTabAction)
    );
    fieldLabelWrapper: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.fieldLabelWrapper)
    );
    fieldInput: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.fieldInput)
    );

    visibilityDropDown: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.dropDown)
    );
    visibilityPublic: ElementFinder = browser.element(
        by.cssContainingText(
            LibraryMetadata.selectors.visibilityOption,
            'Public'
        )
    );
    ...
    hint: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.hint)
    );
    error: ElementFinder = this.component.element(
        by.css(LibraryMetadata.selectors.error)
    );
    ...
    getLabelWrapper(label: string) {
        return this.component.element(
            by.cssContainingText(
                LibraryMetadata.selectors.fieldLabelWrapper,
                label
            )
        );
    }
    ...
    getFieldByName(fieldName: string) {
        ...
        return wrapper
            .element(by.xpath('..'))
            .element(by.css(LibraryMetadata.selectors.fieldInput));
    }
    ...
    getButton(button: string) {
        return this.component.element(
            by.cssContainingText(
                LibraryMetadata.selectors.metadataTabAction,
                button
            )
        );
    }
    ...
    async isVisibilityEnabled() {
        ...
        const field = wrapper
            .element(by.xpath('..'))
            .element(by.css(LibraryMetadata.selectors.dropDown));
