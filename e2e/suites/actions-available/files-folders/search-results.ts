        ...
        describe('on a file', () => {
            ...
            it('File Office - [C297637]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.fileDocx.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.fileDocx.name,
                    testData.fileDocx.searchContextMenu
                );
            });
            ...
            it('File Office, favorite - [C291827]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileDocxFav.name,
                    testData.fileDocxFav.searchContextMenu
                );
            });
            ...
            it('File simple - [C297638]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.file.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.file.name,
                    testData.file.searchContextMenu
                );
            });
            ...
            it('File favorite - [C280661]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.fileFav.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.fileFav.name,
                    testData.fileFav.searchContextMenu
                );
            });
            ...
            it('File Office, shared - [C297627]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileDocxShared.name,
                    testData.fileDocxShared.searchContextMenu
                );
            });
            ...
            it('File Office, shared, favorite - [C280631]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileDocxSharedFav.name,
                    testData.fileDocxSharedFav.searchContextMenu
                );
            });
            ...
            it('File shared - [C280632]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.fileShared.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.fileShared.name,
                    testData.fileShared.searchContextMenu
                );
            });
            ...
            it('File shared, favorite - [C280641]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileSharedFav.name,
                    testData.fileSharedFav.searchContextMenu
                );
            });
            ...
            it('File locked - [C297628]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.fileLocked.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.fileLocked.name,
                    testData.fileLocked.searchContextMenu
                );
            });
            ...
            it('File favorite, locked - [C280648]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileFavLocked.name,
                    testData.fileFavLocked.searchContextMenu
                );
            });
            ...
            it('File shared, locked - [C280574]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileSharedLocked.name,
                    testData.fileSharedLocked.searchContextMenu
                );
            });
            ...
            it('File shared, favorite, locked - [C280642]', async () => {
                ...
                await testUtil.checkContextMenu(
                    testData.fileSharedFavLocked.name,
                    testData.fileSharedFavLocked.searchContextMenu
                );
            });
        });
        ...
        describe('on a folder', () => {
            ...
            it('Folder not favorite  - [C280609]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.folder.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.folder.name,
                    testData.folder.searchContextMenu
                );
            });
            ...
            it('Folder favorite - [C291828]', async () => {
                await testUtil.checkToolbarActions(
                    ...
                    testData.folderFav.searchToolbarMore
                );
                await testUtil.checkContextMenu(
                    testData.folderFav.name,
                    testData.folderFav.searchContextMenu
                );
            });
        });
