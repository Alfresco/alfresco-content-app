...
const fileSharedToolbarPrimary = [
    'Shared Link Settings',
    'Download',
    'View',
    'View Details',
...
const viewerSharedToolbarPrimary = [
...
const searchSharedToolbarPrimary = [
    'Toggle search filter',
    'Shared Link Settings',
    'Download',
    'View',
...
const searchViewerLockedToolbarMore = [
    'Cancel Editing',
    'Upload New Version',
    'Favorite',
    'Copy',
...
const favoritesFolderFavContextMenu = [
    'Download',
    'Edit',
    'Remove Favorite',
    'Move',
...
const favoritesFolderFavToolbarMore = [
    'Edit',
    'Remove Favorite',
    'Move',
    'Copy',
...
const searchFolderToolbarPrimary = [
    'Toggle search filter',
    'Download',
    'View Details',
    'More Actions',
...
const searchFolderFavContextMenu = [
    'Download',
    'Edit',
    'Remove Favorite',
    'Copy',
...
const searchFolderFavToolbarMore = [
    'Edit',
    'Remove Favorite',
    'Copy',
    'Permissions',
...
// TODO: raise issue to remove 'Permissions'
const multipleSelAllFavContextMenu = [
    'Download',
    'Remove Favorite',
    'Move',
    'Copy',
...
// TODO: raise issue to remove 'Permissions'
const multipleSelAllFavToolbarMore = [
    'Remove Favorite',
    'Move',
    'Copy',
    'Delete',
...
// TODO: raise issue to remove 'Permissions'
const searchMultipleSelContextMenu = [
    'Download',
    'Favorite',
    'Copy',
    'Permissions',
...
// TODO: raise issue to remove 'Permissions'
const searchMultipleSelAllFavContextMenu = [
    'Download',
    'Remove Favorite',
    'Copy',
    'Permissions',
...
// TODO: raise issue to remove 'Permissions'
const searchMultipleSelAllFavToolbarMore = [
    'Remove Favorite',
    'Copy',
    'Permissions',
];
