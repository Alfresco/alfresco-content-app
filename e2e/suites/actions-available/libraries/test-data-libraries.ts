...
const searchMemberToolbarPrimary = [
    'Toggle search filter',
    'Leave Library',
    'View Details',
    'More Actions',
];
const searchReqJoinToolbarPrimary = [
    'Toggle search filter',
    'Cancel Join Request',
    'View Details',
    'More Actions',
];
const searchNotMemberToolbarPrimary = [
    'Toggle search filter',
    'Join',
    'View Details',
    'More Actions',
];
const reqJoinToolbarMore = [
    'Cancel Join Request',
    'View Details',
    'More Actions',
];
