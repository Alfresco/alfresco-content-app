...
import { AdminActions, UserActions, LoginPage, BrowsingPage, FILES, RepoClient, Utils, Viewer } from '@alfresco/aca-testing-shared';
...
describe('Viewer general', () => {
  ...
  beforeAll(async (done) => {
    ...
    await adminApiActions.sites.createSite(siteAdmin, 'PRIVATE');
