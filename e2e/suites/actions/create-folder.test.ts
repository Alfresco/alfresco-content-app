...
describe('Create folder', () => {
    ...
    describe('on Personal Files', () => {
        ...
        it('creates new folder with name - [C216341]', async () => {
            ...
            expect(await dataTable.isItemPresent(folderName1)).toBe(
                true,
        ...
        it('creates new folder with name and description - [C216340]', async (done) => {
            ...
            expect(await dataTable.isItemPresent(folderName2)).toBe(
                true,
        ...
        it('dialog UI elements - [C216345]', async () => {
            ...
            expect(await createDialog.isCreateButtonEnabled()).toBe(
                false,
                'Create button is not disabled'
            );
            expect(await createDialog.isCancelButtonEnabled()).toBe(
                true,
        ...
        it('with empty folder name - [C216346]', async () => {
            ...
            expect(await createDialog.getValidationMessage()).toMatch(
        ...
        it('with folder name containing special characters - [C216347]', async () => {
            ...
            for (const name of namesWithSpecialChars) {
                ...
                expect(await createDialog.getValidationMessage()).toContain(
        ...
        it('duplicate folder name - [C216350]', async () => {
            ...
            expect(await createDialog.isDialogOpen()).toBe(
                true,
        ...
        it('trim ending spaces from folder name - [C216351]', async () => {
            ...
            expect(await dataTable.isItemPresent(nameWithSpaces.trim())).toBe(
                true,
                'Folder not displayed in list view'
            );
        });
    ...
    describe('on File Libraries', () => {
        ...
        it('creates new folder with name and description - [C280394]', async () => {
            ...
            expect(await dataTable.isItemPresent(folderSite)).toBe(
                true,
                'Folder not displayed'
            );
            const desc = await apis.user.nodes.getNodeDescription(
