...
export class DataTableComponent extends BaseComponent {
     ...
     * @returns {Locator} reference to menu placed in row localized by the name
     */
    public getActionsButtonByName = (name: string): Locator => this.getRowByName(name).locator('mat-icon', { hasText: new RegExp(`^\\s*more_vert\\s*$`, 'g') });
     ...
     * @returns {Locator} reference to cell element
     */
    public getCellByColumnNameAndRowItem = (item: string | number, columnName: string): Locator => this.getRowByName(item).locator(`[title="${columnName}"]`);
