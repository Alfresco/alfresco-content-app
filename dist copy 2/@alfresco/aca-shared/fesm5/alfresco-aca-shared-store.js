...
/** @type {?} */
var getHeaderColor = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getLogoPath = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getLanguagePickerState = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getUserProfile = createSelector(
  selectApp,
  function(state) {
    return state.user;
  }
...
/** @type {?} */
var getCurrentFolder = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getAppSelection = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getSharedUrl = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getNavigationState = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var isInfoDrawerOpened = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var showFacetFilter = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getDocumentDisplayMode = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getRepositoryStatus = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var isQuickShareEnabled = createSelector(
  getRepositoryStatus,
  function(info) {
...
/** @type {?} */
var getSideNavState = createSelector(
  getAppSelection,
  getNavigationState,
...
/** @type {?} */
var getRuleContext = createSelector(
  getAppSelection,
  getNavigationState,
  getUserProfile,
  getRepositoryStatus,
...
/** @type {?} */
var infoDrawerMetadataAspect = createSelector(
  selectApp,
  function(state) {
...
/** @type {?} */
var getProcessServicesState = createSelector(
  selectApp,
  function(state) {
