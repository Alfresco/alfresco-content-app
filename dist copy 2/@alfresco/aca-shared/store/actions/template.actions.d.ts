...
export declare enum TemplateActionTypes {
...
export declare class FileFromTemplate implements Action {
  readonly type = TemplateActionTypes.FileFromTemplate;
  constructor();
}
export declare class FolderFromTemplate implements Action {
  readonly type = TemplateActionTypes.FolderFromTemplate;
  constructor();
}
export declare class CreateFromTemplate implements Action {
  payload: Node;
  readonly type = TemplateActionTypes.CreateFromTemplate;
  constructor(payload: Node);
}
export declare class CreateFromTemplateSuccess implements Action {
  node: Node;
