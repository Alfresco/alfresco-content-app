...
export declare enum UploadActionTypes {
...
export declare class UploadFolderAction implements Action {
  payload: any;
  readonly type = UploadActionTypes.UploadFolder;
  constructor(payload: any);
}
export declare class UploadFileVersionAction implements Action {
