  ...
  [1],
  {
    ...
    Afnz: function(t, n, r) {
      ...
      t.exports = function(t, n, r, p, g, y, d) {
        ...
        var x,
          ...
          K = !1,
          O = t.prototype,
          w = O[l] || O['@@iterator'] || (g && O[g]),
          M = w || S(g),
          U = g ? (E ? S('entries') : M) : void 0,
          X = ('Array' == n && O.entries) || w;
        if (
          (X &&
    ...
    EK0E: function(t, n, r) {
      ...
      var e,
        ...
        x = (t.exports = r('4LiD')('WeakMap', y, d, a, !0, !0));
      s(function() {
        return 7 != new x().set((Object.freeze || Object)(g), 7).get(g);
      }) &&
        (c((e = a.getConstructor(y, 'WeakMap')).prototype, d),
        (u.NEED = !0),
    ...
    ioFf: function(t, n, r) {
      ...
      for (
        ...
        v($[tt++]);
      for (var nt = M(v.store), rt = 0; nt.length > rt; ) g(nt[rt++]);
      u(u.S + u.F * !V, 'Symbol', {
        for: function(t) {
          ...
          function(t, n) {
            ...
            for (var b, S = '', m = 0, E = 0; E < x.length; E++) {
              ...
              for (
                ...
                w.push(void 0 === (b = F[M]) ? b : String(b));
              var U = F.groups;
              if (v) {
                var X = [K].concat(w, O, h);
                void 0 !== U && X.push(U);
                var A = String(n.apply(void 0, X));
              } else A = g(K, h, O, w, U, n);
