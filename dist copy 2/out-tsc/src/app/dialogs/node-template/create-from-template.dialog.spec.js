...
describe('CreateFileFromTemplateDialogComponent', function() {
  var fixture;
  var component;
  var store;
  var data = {
  ...
  it('should populate form with provided dialog data', function() {
  ...
  it('should invalidate form if required `name` field is invalid', function() {
    fixture.detectChanges();
    component.form.controls.name.setValue('');
    fixture.detectChanges();
    expect(component.form.invalid).toBe(true);
  });
  it('should invalidate form if required `name` field has `only spaces`', function() {
    fixture.detectChanges();
    component.form.controls.name.setValue('   ');
    fixture.detectChanges();
    expect(component.form.invalid).toBe(true);
  });
  it('should invalidate form if required `name` field has `ending dot`', function() {
    fixture.detectChanges();
    component.form.controls.name.setValue('something.');
    fixture.detectChanges();
    expect(component.form.invalid).toBe(true);
  });
  it('should invalidate form if `title` text length is long', function() {
    fixture.detectChanges();
    component.form.controls.title.setValue(text(260));
    fixture.detectChanges();
    expect(component.form.invalid).toBe(true);
  });
  it('should invalidate form if `description` text length is long', function() {
    fixture.detectChanges();
    component.form.controls.description.setValue(text(520));
    fixture.detectChanges();
    expect(component.form.invalid).toBe(true);
  });
  it('should create node from template with form values', function() {
    var newNode = {
      id: 'node-id',
      name: 'new-node-name',
      isFolder: false,
...
//# sourceMappingURL=create-from-template.dialog.spec.js.map
