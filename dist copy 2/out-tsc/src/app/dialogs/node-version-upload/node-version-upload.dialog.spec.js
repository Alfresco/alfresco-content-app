...
describe('NodeVersionsDialogComponent', function() {
  var fixture;
  beforeEach(function() {
  ...
  it('should render version form component', function() {
    expect(
      fixture.debugElement.nativeElement.querySelector('app-node-version-form')
    ).not.toBe(null);
  });
  it('should have UPLOAD button state enabled by default', function() {
    var uploadButton = fixture.debugElement.nativeElement.querySelectorAll(
      'button'
    )[1];
  ...
  it('should have UPLOAD button disabled if for is invalid', function() {
    var uploadButton = fixture.debugElement.nativeElement.querySelectorAll(
      'button'
    )[1];
    var versionFormComponent = fixture.debugElement.query(
...
//# sourceMappingURL=node-version-upload.dialog.spec.js.map
