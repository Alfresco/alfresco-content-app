...
var TestComponent = /** @class */ (function() {
  ...
  tslib_1.__decorate(
    [ViewChild('lock'), tslib_1.__metadata('design:type', LockNodeDirective)],
...
describe('LockNodeDirective', function() {
  var fixture;
  var api;
  var component;
  setupTestBed({
  ...
  it('should return false if selection is null', function() {
    component.selection = null;
    fixture.detectChanges();
    expect(component.directive.isNodeLocked()).toBe(false);
  });
  it('should return false if selection is not locked', function() {
    component.selection = { entry: { name: 'test-name', properties: {} } };
    fixture.detectChanges();
    expect(component.directive.isNodeLocked()).toBe(false);
  });
  it('should return true if selection is locked', function() {
    component.selection = {
      entry: {
        name: 'test-name',
  ...
  it('should lock selection', fakeAsync(function() {
    component.selection = {
      entry: {
        id: 'id',
        name: 'test-name',
  ...
  it('should unlock selection', fakeAsync(function() {
    component.selection = {
      entry: {
        id: 'id',
        name: 'test-name',
...
//# sourceMappingURL=lock-node.directive.spec.js.map
