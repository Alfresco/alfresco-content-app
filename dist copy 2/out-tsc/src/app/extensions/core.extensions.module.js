...
var CoreExtensionsModule = /** @class */ (function() {
  function CoreExtensionsModule(extensions) {
  ...
  CoreExtensionsModule_1 = CoreExtensionsModule;
  CoreExtensionsModule.forRoot = function() {
    return {
      ngModule: CoreExtensionsModule_1,
      providers: [
        {
  ...
  CoreExtensionsModule.forChild = function() {
    return {
      ngModule: CoreExtensionsModule_1
    };
  };
  var CoreExtensionsModule_1;
  CoreExtensionsModule = CoreExtensionsModule_1 = tslib_1.__decorate(
    [
      NgModule({
...
//# sourceMappingURL=core.extensions.module.js.map
