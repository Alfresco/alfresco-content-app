...
var ToolbarMenuComponent = /** @class */ (function() {
  ...
  Object.defineProperty(ToolbarMenuComponent.prototype, 'hasChildren', {
    get: function() {
      return (
        this.actionRef &&
  ...
  ToolbarMenuComponent.prototype.trackById = function(_, obj) {
    return obj.id;
  };
  tslib_1.__decorate(
    [Input(), tslib_1.__metadata('design:type', Object)],
    ToolbarMenuComponent.prototype,
    'actionRef',
    void 0
  );
  tslib_1.__decorate(
  ...
  ToolbarMenuComponent = tslib_1.__decorate(
    [
      Component({
