...
var ToolbarMenuItemComponent = /** @class */ (function() {
  function ToolbarMenuItemComponent(extensions) {
    this.extensions = extensions;
  }
  ToolbarMenuItemComponent.prototype.runAction = function() {
    if (this.hasClickAction(this.actionRef)) {
      this.extensions.runActionById(this.actionRef.actions.click);
    }
  };
  ToolbarMenuItemComponent.prototype.hasClickAction = function(actionRef) {
    if (actionRef && actionRef.actions && actionRef.actions.click) {
      return true;
    }
    return false;
  };
  ToolbarMenuItemComponent.prototype.trackById = function(_, obj) {
    return obj.id;
  };
  tslib_1.__decorate(
    [Input(), tslib_1.__metadata('design:type', Object)],
    ToolbarMenuItemComponent.prototype,
    'actionRef',
    void 0
  );
  ToolbarMenuItemComponent = tslib_1.__decorate(
    [
      Component({
...
//# sourceMappingURL=toolbar-menu-item.component.js.map
