...
describe('UserMenuItemComponent', function() {
  var fixture;
  var component;
  ...
  it('should render button action', function() {
    component.actionRef = {
      id: 'action-button',
      title: 'Test Button',
      actions: {
    ...
    var buttonElement = fixture.nativeElement.querySelector('#action-button');
    expect(buttonElement).not.toBe(null);
  });
  it('should render menu action', function() {
    component.actionRef = {
      type: 'menu',
      id: 'action-menu',
      title: 'Test Button',
    ...
    fixture.detectChanges();
    var menuElement = fixture.nativeElement.querySelector('#action-menu');
    expect(menuElement).not.toBe(null);
  });
  it('should render custom action', function() {
    component.actionRef = {
      type: 'custom',
      id: 'action-custom',
    ...
    fixture.detectChanges();
    var componentElement = fixture.nativeElement.querySelector(
      '#custom-component'
    );
    expect(componentElement).not.toBe(null);
  });
  it('should run defined action', function() {
...
//# sourceMappingURL=user-menu-item.component.spec.js.map
