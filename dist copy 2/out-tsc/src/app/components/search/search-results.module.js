...
var AppSearchResultsModule = /** @class */ (function() {
  function AppSearchResultsModule() {}
  AppSearchResultsModule = tslib_1.__decorate(
    [
      NgModule({
        imports: [
          CommonModule,
  ...
  return AppSearchResultsModule;
})();
export { AppSearchResultsModule };
