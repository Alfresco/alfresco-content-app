...
var AppPermissionsModule = /** @class */ (function() {
  function AppPermissionsModule() {}
  AppPermissionsModule = tslib_1.__decorate(
    [
      NgModule({
        imports: [
          CommonModule,
  ...
  return AppPermissionsModule;
})();
export { AppPermissionsModule };
