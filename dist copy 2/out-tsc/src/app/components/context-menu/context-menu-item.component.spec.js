...
describe('ContextMenuComponent', function() {
  ...
  it('should render defined menu actions items', function() {
    component.actionRef = contextItem;
    fixture.detectChanges();
    var buttonElement = fixture.nativeElement.querySelector('button');
    expect(buttonElement.querySelector('span').innerText.trim()).toBe(
      contextItem.title
    );
  });
  it('should not run action when entry has no click attribute defined', function() {
  ...
  it('should run action with provided action id', function() {
    spyOn(extensionsService, 'runActionById');
    component.actionRef = contextItem;
    fixture.detectChanges();
    fixture.nativeElement
...
//# sourceMappingURL=context-menu-item.component.spec.js.map
