...
var AppInfoDrawerModule = /** @class */ (function() {
  function AppInfoDrawerModule() {}
  AppInfoDrawerModule = tslib_1.__decorate(
    [
      NgModule({
        imports: [
          CommonModule,
  ...
  return AppInfoDrawerModule;
})();
export { AppInfoDrawerModule };
