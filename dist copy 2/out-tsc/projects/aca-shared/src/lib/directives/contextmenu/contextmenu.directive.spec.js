...
describe('ContextActionsDirective', function() {
  var directive;
  var storeMock = {
  ...
  it('should not render context menu when `enabled` property is false', function() {
    directive.enabled = false;
    directive.onContextMenuEvent(new MouseEvent('contextmenu'));
    expect(storeMock.dispatch).not.toHaveBeenCalled();
  });
  it('should call service to render context menu', fakeAsync(function() {
    var el = document.createElement('div');
    el.className =
      'adf-datatable-cell adf-datatable-cell--text adf-datatable-row';
    var fragment = document.createDocumentFragment();
    fragment.appendChild(el);
    var target = fragment.querySelector('div');
    var mouseEventMock = { preventDefault: function() {}, target: target };
    directive.ngOnInit();
...
//# sourceMappingURL=contextmenu.directive.spec.js.map
