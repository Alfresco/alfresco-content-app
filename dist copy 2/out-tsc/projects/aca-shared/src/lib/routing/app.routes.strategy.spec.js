...
describe('AppRouteReuseStrategy', function() {
  var appRouteReuse;
  beforeEach(function() {
  ...
  it('should allow detach if route is configured to be reused', function() {
    var route = {
      routeConfig: {
        data: {
          reuse: true
  ...
  it('should store on routeCache', function() {
    var route = {
      url: [],
      routeConfig: {
        data: {
  ...
  it('should clear routeCache on resetCache', function() {
    var route = {
      url: [],
      routeConfig: {
        data: {
...
//# sourceMappingURL=app.routes.strategy.spec.js.map
