...
describe('Pagination on multiple pages', function () {
    ...
    var sites = Array(101)
        .fill('site')
        .map(function (name, index) { return name + "-" + (index + 1) + "-" + random; });
    beforeAll(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, userApi.sites.createSitesPrivate(sites)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, userApi.sites.waitForApi({ expect: 101 })];
                case 3:
                    _a.sent();
    ...
    afterAll(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userApi.sites.deleteSites(sites)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    describe('on My Libraries', function () {
        ...
        it('Pagination control default values - [C280086]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('Items per page values - [C280087]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
        ...
        it('current page menu items - [C280088]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('change the current page from menu - [C280089]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 7:
                        ...
                        _e = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-60')];
                    case 8:
                        _e.apply(void 0, [_f.sent()]).toBe(true, 'Site-60 not found on page');
        ...
        it('navigate to next and previous pages - [C280092]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _b = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-31')];
                    case 4:
                        _b.apply(void 0, [_e.sent()]).toBe(true, 'Site-31 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 5:
                        _e.sent();
                        return [4 /*yield*/, pagination.openCurrentPageMenu()];
                    ...
                    case 11:
                        ...
                        _d = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-12')];
                    case 12:
                        _d.apply(void 0, [_e.sent()]).toBe(true, 'Site-12 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 13:
                        _e.sent();
                        return [2 /*return*/];
        ...
        it('Previous button is disabled on first page - [C280090]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b;
        ...
        it('Next button is disabled on last page - [C280091]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
    ...
    describe('on Favorite Libraries', function () {
        ...
        it('Pagination control default values - [C291875]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
        ...
        it('Items per page values - [C291876]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, pagination.openMaxItemsMenu()];
        ...
        it('current page menu items - [C291877]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    case 0: return [4 /*yield*/, pagination.openMaxItemsMenu()];
        ...
        it('change the current page from menu - [C291878]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
                    ...
                    case 7:
                        _d.apply(void 0, [_f.sent()]).toBe(true, 'Next button is not enabled');
                        _e = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-40')];
                    case 8:
                        _e.apply(void 0, [_f.sent()]).toBe(true, 'Site-60 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 9:
        ...
        it('navigate to next and previous pages - [C291881]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, pagination.clickNext()];
                    ...
                    case 3:
                        _a.apply(void 0, [_e.sent()]).toContain('26-50 of 101');
                        _b = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-70')];
                    case 4:
                        _b.apply(void 0, [_e.sent()]).toBe(true, 'Site-31 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 5:
                    ...
                    case 11:
                        _c.apply(void 0, [_e.sent()]).toContain('1-25 of 101');
                        _d = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('site-88')];
                    case 12:
                        _d.apply(void 0, [_e.sent()]).toBe(true, 'Site-12 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 13:
        ...
        it('Previous button is disabled on first page - [C291879]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
        ...
        it('Next button is disabled on last page - [C291880]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
...
//# sourceMappingURL=multiple-pages-libraries.test.js.map