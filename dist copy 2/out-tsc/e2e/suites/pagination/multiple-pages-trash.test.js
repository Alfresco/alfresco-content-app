...
describe('Pagination on multiple pages on Trash', function () {
    var random = Utils.random();
    var username = "user-" + random;
    var filesForDelete = Array(101)
        .fill('file')
    ...
    beforeAll(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, userApi.nodes.createFiles(filesForDelete)];
                case 2:
                    filesDeletedIds = (_a.sent()).list.entries.map(function (entries) { return entries.entry.id; });
                    return [4 /*yield*/, userApi.nodes.deleteNodesById(filesDeletedIds, false)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, userApi.trashcan.waitForApi({ expect: 101 })];
                case 4:
                    _a.sent();
    ...
    afterAll(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userApi.trashcan.emptyTrash()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Pagination control default values - [C280122]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    it('Items per page values - [C280123]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c;
    ...
    it('current page menu items - [C280124]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    it('change the current page from menu - [C280125]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, _d, _e;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 7:
                    ...
                    _e = expect;
                    return [4 /*yield*/, dataTable.isItemPresent('file-40')];
                case 8:
    ...
    it('navigate to next and previous pages - [C280128]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, _d;
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _b = expect;
                    return [4 /*yield*/, dataTable.isItemPresent('file-70')];
                case 4:
                ...
                case 11:
                    ...
                    _d = expect;
                    return [4 /*yield*/, dataTable.isItemPresent('file-88')];
                case 12:
    ...
    it('Previous button is disabled on first page - [C280126]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a, _b;
    ...
    it('Next button is disabled on last page - [C280127]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
...
//# sourceMappingURL=multiple-pages-trash.test.js.map