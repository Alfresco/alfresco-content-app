...
export function personalFilesTests(parentName) {
    ...
    describe('Pagination controls : ', function () {
        ...
        it('Pagination control default values - [C280077]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('Items per page values - [C280078]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
        ...
        it('current page menu items - [C280079]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('change the current page from menu - [C280080]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 7:
                        ...
                        _e = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('my-file-60')];
                    case 8:
        ...
        it('navigate to next and previous pages - [C280083]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _b = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('my-file-31')];
                    case 4:
                        _b.apply(void 0, [_e.sent()]).toBe(true, 'file-31 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 5:
                        _e.sent();
                        return [4 /*yield*/, pagination.openCurrentPageMenu()];
                    ...
                    case 11:
                        ...
                        _d = expect;
                        return [4 /*yield*/, dataTable.isItemPresent('my-file-12')];
                    case 12:
                        _d.apply(void 0, [_e.sent()]).toBe(true, 'my-file-12 not found on page');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 13:
                        _e.sent();
                        return [2 /*return*/];
        ...
        it('Previous button is disabled on first page - [C280081]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b;
        ...
        it('Next button is disabled on last page - [C280082]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
