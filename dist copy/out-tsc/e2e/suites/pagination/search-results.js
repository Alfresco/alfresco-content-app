...
export function searchResultsTests() {
    ...
    describe('Pagination controls : ', function () {
        beforeAll(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, searchInput.searchFor('my-file-')];
                    case 2:
                        _a.sent();
        ...
        it('Pagination control default values - [C290125]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('Items per page values - [C290126]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
        ...
        it('current page menu items - [C290127]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        it('change the current page from menu - [C290128]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, pagination.getRange()];
                    case 4:
                        _a.apply(void 0, [_e.sent()]).toContain('51-75 of 101');
                        _b = expect;
                        return [4 /*yield*/, pagination.getCurrentPage()];
                    case 5:
                        _b.apply(void 0, [_e.sent()]).toContain('Page 3');
                        _c = expect;
                        return [4 /*yield*/, pagination.isPreviousEnabled()];
                    case 6:
                        _c.apply(void 0, [_e.sent()]).toBe(true, 'Previous button is not enabled');
                        _d = expect;
                        return [4 /*yield*/, pagination.isNextEnabled()];
                    case 7:
                        _d.apply(void 0, [_e.sent()]).toBe(true, 'Next button is not enabled');
        ...
        it('navigate to next and previous pages - [C290131]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, pagination.getRange()];
                    case 3:
                        _a.apply(void 0, [_c.sent()]).toContain('26-50 of 101');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 4:
                        _c.sent();
                        return [4 /*yield*/, pagination.openCurrentPageMenu()];
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, pagination.getRange()];
                    case 10:
                        _b.apply(void 0, [_c.sent()]).toContain('1-25 of 101');
                        return [4 /*yield*/, pagination.resetToDefaultPageNumber()];
                    case 11:
                        _c.sent();
                        return [2 /*return*/];
        ...
        it('Previous button is disabled on first page - [C290129]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
        ...
        it('Next button is disabled on last page - [C290130]', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, pagination.openCurrentPageMenu()];
