...
import { of } from 'rxjs';
describe('NodeTemplateService', function() {
  var dialog;
  var store;
  ...
  it('should open dialog with parent node `id` as data property', function() {
    spyOn(
  ...
  it('should remove parents for templates node breadcrumb path', function() {
    spyOn(
      alfrescoApiService.getInstance().nodes,
      'getNodeInfo'
    ).and.returnValue(
    ...
    spyOn(dialog, 'open');
    nodeTemplateService.selectTemplateDialog(fileTemplateConfig);
    var breadcrumb = dialog.open['calls']
      .argsFor(0)[1]
  ...
  it('should raise an error when getNodeInfo fails', fakeAsync(function() {
    spyOn(
      alfrescoApiService.getInstance().nodes,
      'getNodeInfo'
    ).and.returnValue(
  ...
  it('should return true if row is not a `link` nodeType', function() {
    spyOn(
      alfrescoApiService.getInstance().nodes,
      'getNodeInfo'
    ).and.returnValue(
  ...
  it('should return false if row is a `filelink` nodeType', function() {
    spyOn(
      alfrescoApiService.getInstance().nodes,
      'getNodeInfo'
    ).and.returnValue(
  ...
  it('should return false if row is a `folderlink` nodeType', function() {
    spyOn(
      alfrescoApiService.getInstance().nodes,
      'getNodeInfo'
    ).and.returnValue(
  ...
  describe('File templates', function() {
    it('should return false if selected node is not a file', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ...
      spyOn(dialog, 'open');
      nodeTemplateService.selectTemplateDialog(fileTemplateConfig);
      var isSelectionValid = dialog.open['calls']
        .argsFor(0)[1]
    ...
    it('should return true if selected node is a template file', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
    ...
    it('should set dialog title for file templates', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
      spyOn(dialog, 'open');
      nodeTemplateService.selectTemplateDialog(fileTemplateConfig);
      var title = dialog.open['calls'].argsFor(0)[1].data.title;
      expect(title).toBe('NODE_SELECTOR.SELECT_FILE_TEMPLATE_TITLE');
    });
  });
  describe('Folder templates', function() {
    it('should return false if selected node is not a folder', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
    ...
    it('should return false if current node is the parent folder', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
    ...
    it('should return true if selected node is a folder template', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
    ...
    it('should set dialog title for folder templates', function() {
      spyOn(
        alfrescoApiService.getInstance().nodes,
        'getNodeInfo'
      ).and.returnValue(of({ id: 'templates-folder-id' }));
...
//# sourceMappingURL=node-template.service.spec.js.map
