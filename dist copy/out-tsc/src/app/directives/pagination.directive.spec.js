...
describe('PaginationDirective', function() {
  ...
  it('should setup supported page sizes from app config', function() {
    spyOn(config, 'get').and.returnValue([21, 31, 41]);
    directive.ngOnInit();
    expect(pagination.supportedPageSizes).toEqual([21, 31, 41]);
  });
  it('should update preferences on page size change', function() {
    directive.ngOnInit();
...
//# sourceMappingURL=pagination.directive.spec.js.map
