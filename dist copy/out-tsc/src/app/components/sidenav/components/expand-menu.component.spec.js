...
describe('ExpandMenuComponent', function() {
  var component;
  var fixture;
  var router;
  beforeEach(function() {
  ...
  it('should render action item', function() {
    ...
    var actionButton = document.body.querySelector('#test-action-button');
    expect(actionButton).not.toBeNull();
  });
  it('should render action item with children', function() {
    component.item = {
      id: 'test-action-button',
      children: [
        {
    ...
    fixture.detectChanges();
    var actionButton = document.body.querySelector('[id="test-action-button"]');
...
//# sourceMappingURL=expand-menu.component.spec.js.map
