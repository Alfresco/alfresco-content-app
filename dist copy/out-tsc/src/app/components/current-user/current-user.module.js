...
var AppCurrentUserModule = /** @class */ (function() {
  function AppCurrentUserModule() {}
  AppCurrentUserModule = tslib_1.__decorate(
    [
      NgModule({
        imports: [
          CommonModule,
  ...
  return AppCurrentUserModule;
})();
export { AppCurrentUserModule };
