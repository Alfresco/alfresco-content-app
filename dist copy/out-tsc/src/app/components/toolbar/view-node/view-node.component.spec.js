...
describe('ToggleFavoriteComponent', function() {
  ...
  it('should render as a menu button', function() {
    component.data = {
      menuButton: true
    };
  ...
  it('should render as a icon button', function() {
    component.data = {
      iconButton: true
    };
    fixture.detectChanges();
  ...
  it('should call ViewNodeAction onClick event', function() {
    component.data = {
      iconButton: true
    };
    fixture.detectChanges();
...
//# sourceMappingURL=view-node.component.spec.js.map
