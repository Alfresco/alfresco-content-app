...
describe('ContextMenuService', function() {
  ...
  it('should create a custom overlay', function() {
  ...
  it('should have default LTR direction value', function() {
    contextMenuService = new ContextMenuService(
      injector,
      overlay,
      userPreferencesService
  ...
  it('should change direction on textOrientation event', function() {
