...
describe('SharedLinkViewComponent', function() {
  var component;
  var fixture;
  var alfrescoApiService;
  var appExtensionService;
  var spyGetSharedLink;
  var storeMock = {
  ...
  it('should update store selection', fakeAsync(function() {
    ...
    expect(storeMock.dispatch).toHaveBeenCalledWith(
      new SetSelectedNodesAction([{ entry: { id: 'shared-id' } }])
    );
  }));
  it('should not update store on error', fakeAsync(function() {
    spyGetSharedLink.and.returnValue(Promise.reject('error'));
    fixture.detectChanges();
    tick();
    expect(storeMock.dispatch).not.toHaveBeenCalled();
  }));
  it('should not update actions reference if selection is empty', fakeAsync(function() {
  ...
  it('should update actions reference if selection is not empty', fakeAsync(function() {
  ...
  it('should fetch link id from the active route', fakeAsync(function() {
    spyGetSharedLink.and.returnValue(
      Promise.resolve({ entry: { id: 'shared-id' } })
    );
    fixture.detectChanges();
...
//# sourceMappingURL=shared-link-view.component.spec.js.map
