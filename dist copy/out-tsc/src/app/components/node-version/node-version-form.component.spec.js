...
describe('AppNodeVersionFormComponent', function() {
  var fixture;
  var component;
  setupTestBed({
  ...
  it('should have minor version option selected', function() {
    var isSelected = fixture.debugElement.nativeElement
      .querySelectorAll('.form__version--option')[0]
      .classList.contains('mat-radio-checked');
    expect(isSelected).toBe(true);
  });
  it('should emit form state on changes', function() {
    var formData = {
      comment: 'some text',
      version: true
    };
  ...
  it('form should have valid state upon initialization', function() {
    expect(component.form.valid).toBe(true);
  });
});
//# sourceMappingURL=node-version-form.component.spec.js.map
