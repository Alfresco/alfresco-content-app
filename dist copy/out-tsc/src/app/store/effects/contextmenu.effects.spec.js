...
describe('ContextMenuEffects', function() {
  var store;
  ...
  it('should close dialog reference if previously was opened', function() {
    store.dispatch(new ContextMenu(new MouseEvent('click')));
    expect(contextMenuService.open).toHaveBeenCalled();
    store.dispatch(new ContextMenu(new MouseEvent('click')));
...
//# sourceMappingURL=contextmenu.effects.spec.js.map
