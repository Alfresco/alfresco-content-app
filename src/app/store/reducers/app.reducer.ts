    ...
    switch (action.type) {
        case AppActionTypes.SetInitialState:
            newState = Object.assign(
                {},
                (action as SetInitialStateAction).payload
            );
            break;
        ...
        case NodeActionTypes.SetSelection:
            newState = updateSelectedNodes(
                state,
                action as SetSelectedNodesAction
            );
            break;
        ...
        case AppActionTypes.SetCurrentFolder:
            newState = updateCurrentFolder(
                state,
                action as SetCurrentFolderAction
            );
            break;
