    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    // deprecated, backwards compatibility with ACA 1.8
                    {
                        path: 'preview/:nodeId',
                        loadChildren:
                            './components/preview/preview.module#PreviewModule',
                        data: {
                ...
                children: [
                    {
                        ...
                        data: {
                            title:
                                'APP.BROWSE.LIBRARIES.MENU.FAVORITE_LIBRARIES.TITLE',
            ...
            },
            {
                path: 'trashcan',
                loadChildren:
                    './components/trashcan/trashcan.module#AppTrashcanModule',
            },
            {
                path: 'about',
