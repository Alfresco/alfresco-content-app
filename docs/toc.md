...
- [Getting started](/getting-started)
    ...
    - [Internationalization (i18n)](/getting-started#internationalization-i18n)
    - [CORS](/getting-started#cors)
    - [Configuration](/getting-started#configuration)
        - [Server settings](/getting-started#server-settings)
        - [Application settings](/getting-started#application-settings)
        - [Your custom settings](/getting-started#your-custom-settings)
