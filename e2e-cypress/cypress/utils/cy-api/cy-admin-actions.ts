...
import { PersonModel, SitesApi, UploadApi, NodesApi, FavoritesApi, SearchApi, NodeContentTree, Person, SharedLinksApi } from './cy-repo-client/apis';
import { CyUserActions } from './cy-user-actions';
// import { browser } from 'protractor';

export class CyAdminActions extends CyUserActions {
  constructor() {
    super();
  }
  ...
  async login(username?: string, password?: string) {
    return super.login(username || Cypress.env('params').ADMIN_USERNAME, password || Cypress.env('params').ADMIN_PASSWORD);
  }
