 ...
 */
export class CyRepoClient {
  alfrescoApi: AlfrescoApi;

  constructor(private username: string = Cypress.env('params').ADMIN_USERNAME, private password: string = Cypress.env('params').ADMIN_PASSWORD) {
    this.alfrescoApi = new AlfrescoApi();
    this.alfrescoApi.setConfig(Cypress.env('params').config);
  }
