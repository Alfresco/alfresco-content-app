...
import { CyBrowsingPage } from './cy-browsing-page';
import { CySearchFilters } from '../components';
// import { SearchSortingPicker } from '../components/search/search-sorting-picker';
// import { SearchFilters } from '../components/search/search-filters';

export class CySearchResultsPage extends CyBrowsingPage {
  ...
  filters = new CySearchFilters('aca-search-results');
