...
import { CyGenericDialog } from '../dialog/cy-generic-dialog';
import { /* isPresentAndDisplayed, isPresentAndEnabled,*/ typeText } from '../../utils/cy-utils';

export class CyCreateOrEditFolderDialog extends CyGenericDialog {
  actionBtn = '.mat-dialog-actions button';
  // createBtn = this.childElement(by.cssContainingText('.mat-dialog-actions button', 'Create'));
  ...
  nameInput = 'input[data-placeholder="Name" i]';
  ...
  get createButton() {
    return cy.get(this.actionBtn).contains('Create');
  }
