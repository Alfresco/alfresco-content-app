...
export type RuleConditionFieldType = 'string' | 'number' | 'date' | 'type' | 'special' | 'mimeType' | 'autocomplete';
...
export const comparatorHiddenForConditionFieldType: string[] = ['special', 'mimeType', 'autocomplete'];
