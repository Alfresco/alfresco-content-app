...
export class CreateOrEditFolderDialog extends GenericDialog {
  ...
  nameInput = this.rootElem.element(by.css('input[id="adf-folder-name-input"]'));
  descriptionTextArea = this.rootElem.element(by.css('textarea[id="adf-folder-description-input"]'));
