...
export class AdfInfoDrawerComponent extends BaseComponent {
  ...
  public infoDrawerPanel = this.getChild('.adf-info-drawer');
  ...
  public hintMessage = this.getChild('mat-hint');
  public errorMessage = this.getChild('mat-error');
  public expandDetailsButton = this.getChild(`button[title='Expand panel']`);
  public expandedDetailsTabs = this.getChild('.aca-details-container .mdc-tab__text-label');
